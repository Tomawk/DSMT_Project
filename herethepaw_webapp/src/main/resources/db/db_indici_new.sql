...
CREATE TABLE `booking` (
  ...
  `petowner_id` varchar(45) NOT NULL,
  `petowner_username` varchar(45) NOT NULL,
  `petsitter_id` varchar(45) NOT NULL,
  `petsitter_username` varchar(45) NOT NULL,
...
CREATE TABLE `pets_user` (
  ...
  `dog` bit(1) NOT NULL,
  `cat` bit(1) NOT NULL,
  `rabbit` bit(1) NOT NULL,
  `hamster` bit(1) NOT NULL,
  PRIMARY KEY (`user_id`)
...
INSERT INTO `review` VALUES (1,'11b1fd2d481a638a0d6b8d38f0d1732e','1acccfd6017be27484cdd691c9b05153','Fenomenale!',3,'2022-01-22 10:31:52'),(2,'11b1fd2d481a638a0d6b8d38f0d1732e','1acccfd6017be27484cdd691c9b05153','Bravo!',5,'2022-01-22 10:32:20'),(3,'11b1fd2d481a638a0d6b8d38f0d1732e','1acccfd6017be27484cdd691c9b05153','Very good experience!',2,'2022-01-22 10:39:01'),(4,'11b1fd2d481a638a0d6b8d38f0d1732e','1acccfd6017be27484cdd691c9b05153','Wow!',3,'2022-01-22 10:39:36'),(5,'11b1fd2d481a638a0d6b8d38f0d1732e','1acccfd6017be27484cdd691c9b05153','Good!',5,'2022-01-22 10:40:04'),(6,'a27042907f0e701c742edb30679ea232','1acccfd6017be27484cdd691c9b05153','Nice Experience!',4,'2022-01-25 15:07:47'),(7,'11b1fd2d481a638a0d6b8d38f0d1732e','1acccfd6017be27484cdd691c9b05153','Excellent service!',5,'2022-01-26 15:37:56'),(9,'11b1fd2d481a638a0d6b8d38f0d1732e','04f64952ad8827633f9eba30d3e5b969','Nice petsitterrr!',5,'2022-01-26 18:38:01');
